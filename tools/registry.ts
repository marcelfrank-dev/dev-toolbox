...
const toolComponents: Record<string, ComponentType> = {
  ...
  'license-generator': dynamic(() => import('./license/LicenseGenerator'), { ssr: false }),
  ...
  'border-radius-generator': dynamic(() => import('./border-radius/BorderRadiusGenerator'), { ssr: false }),
  ...
  'htaccess-generator': dynamic(() => import('./htaccess/HtaccessGenerator'), { ssr: false }),
